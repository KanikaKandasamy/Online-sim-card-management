...
$q = "SELECT price FROM rate WHERE des='Network Change Rate'"; 
...
<br>
<form method="POST" action="netwalletdb.php">
...
<button type="submit" class="signupbtn" style="align:center;">Cancel</button><br>
<button type="submit" class="signupbtn" style="align:center;">Wallet</button>
  </form>
  </p>
</div>
</center>
