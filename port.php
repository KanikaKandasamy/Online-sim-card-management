...
<div id="mySidenav" class="sidenav">
  ...
  <a class="active "href="#">Port Change</a>
...
<div class="topnav">
  ...
  <form method="POST" action="portdb.php">
<center>
<br>
<div class="row">
  ...
  <br><br>
	  <label for="no"><b>Mobile Number</b></label>
	   ...
	   <br><br><br>
   <label for="np"><b>Current Network Operator</b></label>
    <select style="width:90%;height:7%;" id="np" name="np" >
	 <option value="airtel">Airtel</option>
	  ...
	  <br><br><br>
	  <label for="np"><b>Required Network Operator</b></label>
    <select style="width:90%;height:7%;" id="np" name="np">
<option value="jio">Jio</option>
	 <option value="airtel">Airtel</option>
	  	<option value="bsnl">BSNL</option>
