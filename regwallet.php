...
<br>
<form method="POST" action="regwalletdb.php">
...
<label for="no"><b>Narrative&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </b></label>
	  ...
	  <div id="ph"></div>
	  <?php 
if($ph==''){echo "PhoneNumber:  "; for($i = 0; $i < 10; $i++) { if($i<1)echo mt_rand(7,9); else echo mt_rand(0, 9); }; }else{echo "PhoneNumber:   ".$ph; }?><br>
