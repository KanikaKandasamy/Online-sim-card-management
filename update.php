...
<div id="mySidenav" class="sidenav">
  ...
  <a class="active" href="#">Update plan</a>
...
<button type="button" onclick="window.location='http://localhost/simupdateplan.php';return false;" class="cancelbtn">Update Sim Order Rate</button>
<button type="button" onclick="window.location='http://localhost/netupdateplan.php';return false;" class="cancelbtn">Update Network Change Rate</button>
