...
<div class="topnav">
  ...
  <br>
  <form method="POST" action="updateplandb.php">
   <center>
  <h2>Update Plans</h2>
  <br>
  <br>
...
<td><input type="text" value="<?php echo $row['PRICE']?>" style="width:90%" name="rate" required></td>
					</tr>
                <?php
            }
    ?>
...
<button type="button" onclick="window.location='http://localhost/updateplan.php';return false;" class="cancelbtn">Update</button>
