...
<p style="padding-left:30px;"
  <br><br><br>
<center><h2 style="text-align:center;">SIMPAL Wallet</h2> </center>
<br>
<form method="POST" action="walletdb.php">
...
<label for="no"><b>Narrative&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </b></label>
	   ...
	   <br>
	  <br>    
<label for="amount" style="float:left;padding-left:405px;"><b>Amount</b>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<?php echo $a; ?></label>
<br><br>
<button type="submit" class="signupbtn" style="align:center;">Submit</button>
<button type="submit" onclick="window.location='http://localhost/recharge.php';return false;"class="signupbtn" style="align:center;">Cancel</button><br>
<button type="submit" onclick="window.location='http://localhost/walletupdate.php';return false;" class="signupbtn" style="align:center;">Wallet</button>
  </form>
  </p>
</div>
</center>
