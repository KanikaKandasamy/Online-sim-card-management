...
else
{
	...
	$query = "SELECT ph FROM customer WHERE email =:uname"; 
...
<div class="topnav">
  ...
  <br><br>
  <form method="POST" action="walletupdatedb.php">
    <?php
...
$message = "Hello " . $email . " Your OTP: " . $otp . " for recharge of ".$_POST['amount'] . " to SIMPAL Wallet.";
...
?>
  <label for="onetp"><b>One Time Password&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </b></label>
	   <input type="text" style="width:30%;height:25px;" name="onetp" >
	   <br>
	  <br>   <br>
	  <br>   <br>
	  <button type="submit" name="sendotp" class="signupbtn" style="align:center;">Verify</button>
	  <button type="submit" name="resend" class="signupbtn" style="align:center;">Resend OTP</button>
<br><br>
</center>
</div>
  </form>
